...
import { config, isAiEnabled, isAdoEnabled, isEntraEnabled, isSnowEnabled } from './config/index.js';
...
async function start() {
  ...
  server.listen(config.port, () => {
    ...
    logger.info(`ServiceNow: ${isSnowEnabled ? `enabled (${config.snow.instanceUrl})` : 'disabled (set SNOW_INSTANCE_URL/SNOW_USER/SNOW_PASSWORD)'}`);
  });
